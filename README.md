...
Bootstrap-Exercise is an activity created to show the knowledge we have grasped on bootstrap.
...
Clone this repository to your desired folder:git@github.com:MarkYegon7/Bootstrap-Exercise.git
